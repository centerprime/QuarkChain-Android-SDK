...
public class Transaction {
    ...
    public static Transaction createEthBuyCallTransaction(String from, String to, BigInteger value, String data) {

        return new Transaction(from, null, null, null, to, value, data);
    }
